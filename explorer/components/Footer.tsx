...
const Footer = () => {
    ...
    const footerNavigation = {
        main: [
            ...
            { name: 'FAQ', href: '/faq' },
            { name: 'Privacy Policy', href: 'https://docs.bridge.io/information/privacy-policy' },
            { name: 'Terms of Services', href: 'https://docs.bridge.io/information/terms-of-services' },
            { name: 'Docs', href: 'https://docs.bridge.io/onboarding-sdk/' },
        ],
        social: [
            {
                name: 'Twitter',
    ...
    return (
        <footer className="overflow-hidden py-6 md:grid grid-cols-3 w-full px-6 lg:px-8 mt-auto">
            ...
            <div className="flex justify-center mt-3 md:mt-0 gap-6 order-2 place-self-center">
                <Link target="_blank" href="https://docs.bridge.io/information/privacy-policy" className="text-xs leading-6 text-primary-text-muted hover:text-opacity-70 duration-200 transition-all">
                    Privacy Policy
                </Link>
                <Link target="_blank" href="https://docs.bridge.io/information/terms-of-services" className="text-xs leading-6 text-primary-text-muted hover:text-opacity-70 duration-200 transition-all">
                    Terms of Services
                </Link>
            </div>
