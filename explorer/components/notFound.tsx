        ...
        <div className="px-6 py-12 mx-auto">
            <div className="flex flex-col justify-center items-center">
                ...
                <div className="flex items-center mt-6 gap-x-3">
                    ...
                    <Link href={'http://discord.gg/luxdefi'} target="_blank" className="w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-primary-500 rounded-lg shrink-0 sm:w-auto hover:bg-primary-500/80">
                        Contact support
                    </Link>
                </div>
            </div>
