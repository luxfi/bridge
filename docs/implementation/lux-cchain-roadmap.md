...
- **MPC-7**: Integrate Corona key derivation (HKDF)
...
3. **Key Derivation**: `HKDF(SHA256, coronaShare, "LUX-CCHAIN", 32)`
...
- **Corona**: Post-quantum key anchoring
