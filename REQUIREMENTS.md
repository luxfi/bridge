...
| 3.6 | Document standalone-backend mode for Liquidity.io: how to point `apiHost` at a non-Lux endpoint, what server API contract `app/server/` exposes, what's pluggable. | New doc under `docs/pages/`. |
