...
- `REQUIREMENTS.md` §1, §2, §3, §8 (Phase 2), §9 (Phase 3), §10, §11:
  removed every mention of Liquidity.io as a tenant, removed Phase 2
...
```
rg 'Liquidity\.io|@hanzoai|@zooai/brand|Hanzo AI Inc|Zoo Labs Foundation|Pars Network Foundation|satschel|liquidity\.io' \
