            ...
            <CardContainer {...props} >
                <div className="flex flex-col justify-center space-y-12 p-10 text-muted text-muted-primary-text md:min-h-fit min-h-[400px]">
                    <h1 className="text-xl tracking-tight text-gray-200">
                        <p className="mb-4 text-muted text-muted-primary-text">
                        ...
                        <p className="mt-4 text-muted text-muted-primary-text">
                            Any pending swaps will be completed after maintenance.
                        </p>
                    </h1>
                    <SubmitButton onClick={() => window.open('https://twitter.com/bridge', '_blank')} icon={twitterLogo} isDisabled={false} isSubmitting={false}>Follow for updates</SubmitButton>
                </div>
            </CardContainer>
        </div>
    );
