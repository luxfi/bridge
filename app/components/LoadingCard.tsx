...
const LoadingCard: FC<Props> = ({ name }) => {
    return <div
        className={`bg-level-1 darkest-class md:shadow-card rounded-lg w-full sm:overflow-hidden relative`}
    >
        ...
        <div className="relative px-6">
            <div className="flex items-start">
                <div className={`flex flex-nowrap grow`}>
                    <div className="w-full pb-6 flex flex-col justify-between space-y-5 text-foreground text-foreground-new h-full">
