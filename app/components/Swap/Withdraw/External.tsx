    ...
    return (
        <Widget.Content>
            <div className="w-full py-12 grid grid-flow-row">
                ...
                <div className="flex flex-col text-center place-content-center mt-1 text-lg font-lighter text-foreground text-foreground-new">
                    <p className="text-base font-medium space-y-6 text-foreground text-foreground-new text-center">
