        ...
        <>
            <div className="w-full grid grid-flow-row animate-fade-in">
                <div className="rounded-md w-full grid grid-flow-row">
                    <div className="items-center space-y-1.5 block text-base font-lighter leading-6 text-foreground text-foreground-new">
                        <div className="flex justify-between p items-baseline">
                            <span className="text-left">Id </span>
                            <span className="text-muted text-muted-primary-text">
                        ...
                        <div className="flex justify-between items-baseline">
                            ...
                            {swap && <span className='text-muted text-muted-primary-text font-normal'>{(new Date(swap.created_date)).toLocaleString()}</span>}
                        </div>
                        <hr className='horizontal-gradient' />
                        <div className="flex justify-between items-baseline">
                            <span className="text-left">From  </span>
                            {
                                source && <div className="flex items-center">
                                    ...
                                    <div className="mx-1 text-muted text-muted-primary-text">{source?.display_name}</div>
                                </div>
                            }
                        </div>
                        <hr className='horizontal-gradient' />
                        <div className="flex justify-between items-baseline">
                            <span className="text-left">To </span>
                            {
                                destination && <div className="flex items-center">
                                    ...
                                    <div className="mx-1 text-muted text-muted-primary-text">{destination?.display_name}</div>
                                </div>
                            }
                        </div>
                        <hr className='horizontal-gradient' />
                        ...
                        <div className="flex justify-between items-baseline">
                            ...
                            <span className='text-muted text-muted-primary-text font-normal flex'>
                        ...
                        }
                        {
                            ...
                            <>
                                ...
                                <div className="flex justify-between items-baseline">
                                    ...
                                    <span className='text-muted text-muted-primary-text font-normal'>{swap?.fee} {currency?.asset}</span>
                                </div>
                            </>
                        }
                        {
