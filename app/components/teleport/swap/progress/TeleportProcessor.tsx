        ...
        try {
            ...
            if (res.status) {
                ...
                if (String(msg).includes("InvalidSenderError")) {
                    toast.error(`Invaild Token Sender, Please try using sender's account`);
                } else {
                                ...
                                isMpcSigning ?
                                    ...
                                    : <div className='flex gap-3 items-center'>
                                        ...
                                        <div className='flex items-center gap-3 text-sm'>
                                            <span>Signing from MPC Oracle</span> <a onClick={handleGetMpcSignature} className='underline font-bold cursor-pointer hover:font-extrabold text-[#77aa63]'>Try Again</a>
                                        </div>
                                    </div>
                            }
