...
const PayoutProcessor: React.FC<IProps> = ({
    ...
    const payoutDestinationToken = async () => {
        ...
        console.log("data for bridge mint:::", data)
        ...
        try {
            ...
            const _bridgePayoutTx = await bridgeContract.bridgeMintStealth(
                ...
                data.signedTXInfo_,
                data.tokenAddrStr_,
                String(data.chainId_),
                Number(data.fromTokenDecimal_),
                String(data.vault_)
            );
