    ...
    extend: {
      colors: {
        ...
        primary: {
          ...
          '100': 'rgb(var(--ls-colors-primary-100, 246, 246, 246), <alpha-value>)',
          '200': 'rgb(var(--ls-colors-primary-200, 241, 241, 241), <alpha-value>)',
          '300': 'rgb(var(--ls-colors-primary-300, 237, 237, 237), <alpha-value>)',
          '400': 'rgb(var(--ls-colors-primary-400, 232, 232, 232), <alpha-value>)',
          ...
          'background': 'rgb(var(--ls-colors-backdrop, 18, 18, 18), <alpha-value>)',
