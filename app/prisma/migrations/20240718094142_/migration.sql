/*
  ...
  - You are about to drop the column `deleted` on the `Swap` table. All the data in the column will be lost.
  - You are about to drop the column `newAaaress` on the `Swap` table. All the data in the column will be lost.
