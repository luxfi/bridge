...
export default class ExchangeSettings {
    ...
    public static Initialize() {
        ...
        ExchangeSettings.KnownSettings[KnownInternalNames.Exchanges.Binance] = {
            ...
            UserApiKeyGuideUrl: "/docs/user-docs/using-bridge/getting-api-keys/binance",
            ...
            ExchangeWithdrawalGuideUrl: "/docs/user-docs/using-bridge/withdrawals/binance",
        };
        ...
        ExchangeSettings.KnownSettings[KnownInternalNames.Exchanges.Bitfinex] = {
            UserApiKeyGuideUrl: "/docs/user-docs/using-bridge/getting-api-keys/bitfinex",
            ExchangeApiKeyPageUrl: "https://setting.bitfinex.com/api",
            ExchangeWithdrawalPageUrl: "https://movement.bitfinex.com/withdraw",
            ExchangeWithdrawalGuideUrl: "/docs/user-docs/using-bridge/withdrawals/bitfinex",
        };
        ExchangeSettings.KnownSettings[KnownInternalNames.Exchanges.Bittrex] = {
            UserApiKeyGuideUrl: "/docs/user-docs/using-bridge/getting-api-keys/bittrex-global",
            ExchangeApiKeyPageUrl: "https://global.bittrex.com/Manage?view=api",
            ExchangeWithdrawalPageUrl: "https://global.bittrex.com/balance",
            ExchangeWithdrawalGuideUrl: "/docs/user-docs/using-bridge/withdrawals/bittrex-global",
        ...
        ExchangeSettings.KnownSettings[KnownInternalNames.Exchanges.Coinbase] = {
            EnableDepositAddressConnect: true,
            ExchangeWithdrawalGuideUrl: "/docs/user-docs/your-first-swap/on-ramp/withdraw-from-coinbase",
        };
        ExchangeSettings.KnownSettings[KnownInternalNames.Exchanges.CryptoCom] = {
            UserApiKeyGuideUrl: "/docs/user-docs/using-bridge/getting-api-keys/crypto.com",
        ...
        ExchangeSettings.KnownSettings[KnownInternalNames.Exchanges.Lux] = {
            UserApiKeyGuideUrl: "/docs/user-docs/using-bridge/getting-api-keys/lux.exchange",
            ExchangeApiKeyPageUrl: "https://lux.exchange/settings/api",
            ExchangeWithdrawalPageUrl: "https://lux.exchange/wallet",
            ExchangeWithdrawalGuideUrl: "/docs/user-docs/using-bridge/withdrawals/lux.exchange",
        };
        ExchangeSettings.KnownSettings[KnownInternalNames.Exchanges.Huobi] = {
            ...
            UserApiKeyGuideUrl: "/docs/user-docs/using-bridge/getting-api-keys/huobi-global",
            ExchangeWithdrawalGuideUrl: "/docs/user-docs/using-bridge/withdrawals/huobi-global",
        };
        ExchangeSettings.KnownSettings[KnownInternalNames.Exchanges.Kraken] = {
            ...
            UserApiKeyGuideUrl: "/docs/user-docs/using-bridge/getting-api-keys/kraken",
            ExchangeApiKeyPageUrl: "https://www.kraken.com/u/security/api",
            ExchangeWithdrawalGuideUrl: "/docs/user-docs/using-bridge/withdrawals/kraken",
        ...
        ExchangeSettings.KnownSettings[KnownInternalNames.Exchanges.Kucoin] = {
            ...
            ExchangeWithdrawalGuideUrl: "/docs/user-docs/using-bridge/withdrawals/kucoin",
        };
        ExchangeSettings.KnownSettings[KnownInternalNames.Exchanges.Okex] = {
            UserApiKeyGuideUrl: "/docs/user-docs/using-bridge/getting-api-keys/okx",
            KeyphraseDisplayName: "Passphrase",
            ExchangeApiKeyPageUrl: "https://www.okx.com/account/my-api",
            ExchangeWithdrawalPageUrl: "https://www.okx.com/balance/withdrawal",
            ExchangeWithdrawalGuideUrl: "/docs/user-docs/using-bridge/withdrawals/okx",
        };
