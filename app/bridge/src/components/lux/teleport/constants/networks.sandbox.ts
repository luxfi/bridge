...
export const networks: Network[] = [
  ...
  {
    display_name: 'Liquidity Testnet',
    internal_name: 'LIQUIDITY_TESTNET',
    native_currency: 'LQDTY',
    logo: 'https://cdn.lux.network/bridge/networks/liquidity_testnet.png',
    is_testnet: true,
    is_featured: true,
    ...
    transaction_explorer_template: 'https://explore.test.example.internal/tx/{0}',
    account_explorer_template: 'https://explore.test.example.internal/address/{0}',
    node: 'https://rpc.test.example.internal/rpc',
    currencies: [
      {
        name: 'LQDTY',
        asset: 'LQDTY',
