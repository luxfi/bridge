...
export const networks: Network[] = [
  ...
  },
  {
    ...
    transaction_explorer_template: 'https://explore.test.redacted.com/tx/{0}',
    account_explorer_template: 'https://explore.test.redacted.com/address/{0}',
    node: 'https://rpc.test.redacted.com/rpc',
    currencies: [
      {
        name: 'LQDTY',
        asset: 'LQDTY',
