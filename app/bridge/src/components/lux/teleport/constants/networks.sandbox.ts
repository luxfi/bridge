...
export const networks: Network[] = [
  ...
  },
  {
    ...
    transaction_explorer_template: 'https://explore.test.satschel.com/tx/{0}',
    account_explorer_template: 'https://explore.test.satschel.com/address/{0}',
    node: 'https://rpc.test.satschel.com/rpc',
    currencies: [
      {
        name: 'LQDTY',
        asset: 'LQDTY',
