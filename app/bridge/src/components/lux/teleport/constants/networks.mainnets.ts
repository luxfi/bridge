...
export const networks: Network[] = [
  ...
  },
  {
    ...
    transaction_explorer_template: "https://explore.main.redacted.com/tx/{0}",
    account_explorer_template: "https://explore.main.redacted.com/address/{0}",
    node: "https://rpc.main.redacted.com/rpc",
    currencies: [
      {
        name: "LQDTY",
        asset: "LQDTY",
