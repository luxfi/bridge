...
export const networks: Network[] = [
  ...
  },
  {
    ...
    transaction_explorer_template: "https://explore.main.satschel.com/tx/{0}",
    account_explorer_template: "https://explore.main.satschel.com/address/{0}",
    node: "https://rpc.main.satschel.com/rpc",
    currencies: [
      {
        name: "LQDTY",
        asset: "LQDTY",
