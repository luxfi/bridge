...
export const networks: Network[] = [
  ...
  },
  {
    ...
    logo: "https://cdn.lux.network/bridge/networks/liquidity_mainnet.png",
    is_testnet: false,
    is_featured: true,
    average_completion_time: "00:00:02.0000000",
    chain_id: 8675309,
    status: "active",
    type: "evm",
    refuel_amount_in_usd: 0,
    transaction_explorer_template: "https://explore.main.example.internal/tx/{0}",
    account_explorer_template: "https://explore.main.example.internal/address/{0}",
    node: "https://rpc.main.example.internal/rpc",
    currencies: [
      {
        name: "LQDTY",
        asset: "LQDTY",
        logo: "https://cdn.lux.network/bridge/currencies/liquidity/lqdty.svg",
        contract_address: "0x0000000000000000000000000000000000000000",
        decimals: 18,
        status: "active",
        is_deposit_enabled: true,
      ...
      },
      {
        name: "USDL",
        asset: "USDL",
        logo: "https://cdn.lux.network/bridge/currencies/liquidity/usdl.svg",
        contract_address: "0x848Cff46eb323f323b6Bbe1Df274E40793d7f2c2",
        decimals: 18,
        status: "active",
        is_deposit_enabled: true,
      ...
      },
      {
        name: "BTCL",
        asset: "BTCL",
        logo: "https://cdn.lux.network/bridge/currencies/liquidity/btcl.svg",
        contract_address: "0x1E48D32a4F5e9f08DB9aE4959163300FaF8A6C8e",
        decimals: 18,
        status: "active",
        is_deposit_enabled: true,
      ...
      },
      {
        name: "ETHL",
        asset: "ETHL",
        logo: "https://cdn.lux.network/bridge/currencies/liquidity/ethl.svg",
        contract_address: "0x60E0a8167FC13dE89348978860466C9ceC24B9ba",
        decimals: 18,
        status: "active",
        is_deposit_enabled: true,
