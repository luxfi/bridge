...
const ImtblxWalletWithdrawStep: React.FC<{
  ...
  const handleTransfer = useCallback(async () => {
      ...
      try {
          ...
          const source_currency = source_network.currencies.find(c => c.asset.toLocaleUpperCase() === swap.source_asset.toLocaleUpperCase())
          if (!source_currency) {
