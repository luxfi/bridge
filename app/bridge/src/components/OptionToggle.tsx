...
const OptionToggle: React.FC<NavRadioProps> = ({ value, items, setSelected, label, disabled }) => {
                    ...
                    <RadioGroup.Option
                        ...
                        }
                        {
                            ...
                            <div className="inline-flex items-center ">
                                ...
                                <span className="absolute ml-1 -top-1 -right-2 shadow-sm rounded bg-primary px-2 text-[10px] leading-4 font-semibold "> New </span>
                            </div>
