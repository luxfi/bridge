                        ...
                        <MessageComponent>
                            <MessageComponent.Content icon="red">
                                <div className="text-center">
                                    ...
                                    <h1 className="mt-2 text-4xl font-bold tracking-tight text-muted text-muted-primary-text sm:text-5xl">Page not found.</h1>
                                    <p className="mt-2 text-base text-foreground text-foreground-new">Sorry, we couldn&apos;t find the page you&apos;re looking for.</p>
                                </div>
