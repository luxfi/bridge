...
const footerNavigation = {
  main: [
      { name: 'Product', href: '/' },
      { name: 'Company', href: 'https://lux.partners' },
      { name: 'Help', href: 'https://help.lux.network' },
      { name: 'Privacy Policy', href: 'https://lux.network/privacy' },
      { name: 'Terms of Services', href: 'https://lux.network/terms' },
...
const Footer: React.FC = () => (
  <footer className="flex flex-row justify-between text-muted-2 overflow-hidden py-6 w-full px-6 lg:px-8 mt-auto">
    ...
    <div className="flex justify-center mt-3 md:mt-0 gap-6">
      <Link target="_blank" href="https://lux.network/privacy" className="hover:text-muted text-xs leading-6 duration-200 transition-all">
        Privacy Policy
      </Link>
      <Link target="_blank" href="https://lux.network/terms" className="hover:text-muted text-xs leading-6 duration-200 transition-all">
        Terms of Services
      </Link>
    </div>
    <div className="flex justify-center space-x-6">
    {footerNavigation.social.map((item) => (
      <Link target="_blank" key={item.name} href={item.href} className="hover:text-muted">
