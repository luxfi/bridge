...
export default [
  ...
  },
  {
    ...
    "transaction_explorer_template": "https://explore.dev.redacted.com/tx/{0}",
    "account_explorer_template": "https://explore.dev.redacted.com/address/{0}",
    "currencies": [
      {
        "name": "LQDTY",
        "asset": "LQDTY",
    ...
    "managed_accounts": [],
    "nodes": [
      "https://rpc.dev.redacted.com/ext/bc/C/rpc"
    ]
  },
  {
    "display_name": "Zoo",
