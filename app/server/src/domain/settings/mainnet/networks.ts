...
export default [
  ...
  },
  {
    ...
    "transaction_explorer_template": "https://explore.dev.satschel.com/tx/{0}",
    "account_explorer_template": "https://explore.dev.satschel.com/address/{0}",
    "currencies": [
      {
        "name": "LQDTY",
        "asset": "LQDTY",
    ...
    "managed_accounts": [],
    "nodes": [
      "https://rpc.dev.satschel.com/ext/bc/C/rpc"
    ]
  },
  {
    "display_name": "Zoo",
