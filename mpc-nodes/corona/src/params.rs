//! Cryptographic parameters for Corona
//!
//! This module defines parameter sets for different security levels,
//! following the specifications in the Corona paper.
...
/// Parameters for the Corona signature scheme
...
mod tests {
    ...
    fn test_parameter_validation() {
        let params = CoronaParams::default();
    ...
    fn test_security_levels() {
        let params_128 = CoronaParams::new(SecurityLevel::Level128);
        let params_192 = CoronaParams::new(SecurityLevel::Level192);
        let params_256 = CoronaParams::new(SecurityLevel::Level256);
