...
// XRP deposit detection (rippled account_info) is now implemented; its
// tests live in xrp_test.go. The former "not implemented" assertion was
// retired when checkXRP landed.
