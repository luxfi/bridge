...
import { type StripeOnramp, loadStripeOnramp } from "@stripe/crypto";
...
export const CryptoElements: React.FC<{ stripeOnramp: Promise<StripeOnramp | null>, children?: React.ReactNode }> = ({
    stripeOnramp,
    children
}) => {
        ...
        if (containerRef) {
            ...
            if (clientSecret && stripeOnramp && swapId) {
                ...
                const session = stripeOnramp
                    ...
                    .mount(containerRef)
                const eventListener = async (e: any) => {
