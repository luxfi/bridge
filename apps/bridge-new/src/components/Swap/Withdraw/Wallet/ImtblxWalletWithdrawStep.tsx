...
const ImtblxWalletWithdrawStep: React.FC<Props> = ({ depositAddress }) => {
            ...
            <div className="w-full space-y-5 flex flex-col justify-between h-full ">
                <div className='space-y-4'>
                    <WarningMessage messageType='informing'>
                        ...
                        <GuideLink text={source_network?.display_name} userGuideUrl='https://docs.bridge.lux.network/user-docs/your-first-swap/off-ramp/send-assets-from-immutablex' />
                    </WarningMessage>
                    {
                        !imxAccount &&
