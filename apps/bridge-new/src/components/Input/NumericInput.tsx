...
// Use with Formik
const NumericInput: React.FC<Input> = forwardRef<HTMLInputElement, Input>(
        ...
        return <div>
            ...
            <div className="flex relative w-full">
                <input
                    ...
                    minLength={minLength}
                    maxLength={maxLength}
                    onInput={(event: React.ChangeEvent<HTMLInputElement>) => { replaceComma(event); limitDecimalPlaces(event, precision as number) }}
                    onFocus={onFocus}
                    onBlur={onBlur}
                    type="text"
                    step={step}
