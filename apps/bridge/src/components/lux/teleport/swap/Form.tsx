...
const Swap: FC = () => {
  ...
  React.useEffect(() => {
    setSourceNetwork(networks.find((n: any) => n.status === 'active'))
  }, [])
  ...
  return (
    <Widget className='sm:min-h-[504px] max-w-lg '>
      <Widget.Content>
        <div id='WIDGET_CONTENT' className='relative flex flex-col justify-between w-full mb-3.5 leading-4 border rounded-t-xl overflow-hidden'>
