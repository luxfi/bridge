...
const Contexts: React.FC<{
  ...
  const query: QueryParams = {
    ...(searchParams.get('lockAddress') === 'true' ? { lockAddress: true } : {}),
    ...(searchParams.get('lockNetwork') === 'true' ? { lockNetwork: true } : {}),
    ...(searchParams.get('lockExchange') === 'true' ? { lockExchange: true } : {}),
    ...(searchParams.get('hideRefuel') === 'true' ? { hideRefuel: true } : {}),
    ...(searchParams.get('hideAddress') === 'true' ? { hideAddress: true } : {}),
    ...
    ...(searchParams.get('lockAddress') === 'false' ? { lockAddress: false } : {}),
    ...(searchParams.get('lockNetwork') === 'false' ? { lockNetwork: false } : {}),
    ...(searchParams.get('lockExchange') === 'false' ? { lockExchange: false } : {}),
    ...(searchParams.get('hideRefuel') === 'false' ? { hideRefuel: false } : {}),
    ...(searchParams.get('hideAddress') === 'false' ? { hideAddress: false } : {}),
