...
export async function GET(
  ...
  try {
    ...
    const exchange = exchanges.find((e: any) => (e.internal_name === source_network))
    const network = networks.find((e: any) => (e.internal_name === source_network))
    ...
    return new Response(null, {status: 500, statusText: error.message ?? "Error in fetching source currencies"})
  }
}
